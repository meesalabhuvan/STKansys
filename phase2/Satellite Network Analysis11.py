...
class SatelliteNetworkAnalyzer:
    ...
    def create_scenario(self, start_time="1 Jan 2025 00:00:00.000", duration_hours=24):
        ...
        # Set time period
        self.scenario.SetTimePeriod(start_time, f"{duration_hours} hr")
        self.scenario.Epoch = start_time
        
        # Reset animation time
        self.root.Rewind()
        
        print(f"Scenario created from {start_time} for {duration_hours} hours")
    ...
    def create_satellite(self, name, semi_major_axis_km, eccentricity, 
        ...
        coe_axes.SizeShape.SemimajorAxis = semi_major_axis_km
        coe_axes.SizeShape.Eccentricity = eccentricity
        coe_axes.Orientation.Inclination = inclination_deg
        coe_axes.Orientation.ArgOfPerigee = arg_perigee_deg
        coe_axes.Orientation.AscNode = raan_deg
        coe_axes.LocationType = AgEClassicalLocation.eLocationTrueAnomaly
        coe_axes.Location.Value = true_anomaly_deg
